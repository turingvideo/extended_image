...
typedef ExtendedInteractiveViewerWidgetBuilder = Widget Function(
...
class ExtendedInteractiveViewer extends StatefulWidget {
  ...
  /// large child.
  ExtendedInteractiveViewer.builder({
    super.key,
    this.clipBehavior = Clip.hardEdge,
    @Deprecated(
      'Use panAxis instead. '
    ...
    this.trackpadScrollCausesScale = false,
    this.extended = false,
    required ExtendedInteractiveViewerWidgetBuilder this.builder,
  })  : assert(minScale > 0),
        assert(interactionEndFrictionCoefficient > 0),
        assert(minScale.isFinite),
        assert(maxScale > 0),
  ...
  final ExtendedInteractiveViewerWidgetBuilder? builder;
  ...
  static Vector3 getNearestPointInside(Vector3 point, Quad quad) {
    ...
    final List<Vector3> closestPoints = <Vector3>[
      ExtendedInteractiveViewer.getNearestPointOnLine(
  ...
  State<ExtendedInteractiveViewer> createState() =>
      _ExtendedInteractiveViewerState();
}

class _ExtendedInteractiveViewerState extends State<ExtendedInteractiveViewer>
    with ExtendedImageState, TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(ExtendedInteractiveViewer oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.child != null) {
      child = _ExtendedInteractiveViewerBuilt(
        childKey: _childKey,
      ...
      child = LayoutBuilder(
        builder: (BuildContext context, BoxConstraints constraints) {
          ...
          return _ExtendedInteractiveViewerBuilt(
            childKey: _childKey,
            clipBehavior: widget.clipBehavior,
            constrained: widget.constrained,
            alignment: widget.alignment,
  ...
  late final ExtendedImage _defaultImage;

  @override
  Widget get completedWidget => build(context);
  ...
  @override
  int? get frameNumber => null;

  @override
  ImageProvider<Object> get imageProvider => _defaultImage.image;

  @override
  Object? get imageStreamKey => null;

  @override
  ExtendedImage get imageWidget => _defaultImage;
  ...
  @override
  ExtendedImageSlidePageState? get slidePageState => null;

  @override
  bool get wasSynchronouslyLoaded => false;

  @override
  void onScaleStart(ScaleStartDetails details) => _onScaleStart(details);

  @override
  void onScaleUpdate(ScaleUpdateDetails details) => _onScaleUpdate(details);

  @override
  void onScaleEnd(ScaleEndDetails details) => _onScaleEnd(details);

  @override
  TransformationController? get transformController =>
      _transformationController;
}
...
class _ExtendedInteractiveViewerBuilt extends StatelessWidget {
  const _ExtendedInteractiveViewerBuilt({
    required this.child,
...
Quad _getAxisAlignedBoundingBoxWithRotation(Rect rect, double rotation) {
  ...
  return ExtendedInteractiveViewer.getAxisAlignedBoundingBox(boundariesRotated);
}
...
Offset _exceedsBy(Quad boundary, Quad viewport) {
  ...
  for (final Vector3 point in viewportPoints) {
    final Vector3 pointInside =
        ExtendedInteractiveViewer.getNearestPointInside(point, boundary);
